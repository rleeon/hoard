...
<section class="mx-auto flex max-w-md flex-col items-center px-4 py-16 sm:px-6 sm:py-20">
  ...
  {#if showAccountChoice}
    <div class="mt-10 w-full space-y-4">
      ...
      <button
        class="glow pop-self ring-focus w-full rounded-lg border border-line px-4 py-2.5 text-sm font-medium text-ink-soft transition-colors hover:bg-bg"
  ...
  <div class="mt-10 w-full space-y-5">
    ...
    >
      <svg width="18" height="18" viewBox="0 0 18 18" data-anim="pop" aria-hidden="true">
        <path
          fill="#4285F4"
    ...
    <button
      ...
      disabled={busy || !accepted}
    >
      <svg width="18" height="18" viewBox="0 0 16 16" fill="currentColor" data-anim="pop" aria-hidden="true">
        <path
    ...
    {#if sent}
      ...
      <div class="flex flex-col gap-2">
        <button
          class="glow pop-self ring-focus w-full rounded-lg border border-line px-4 py-2.5 text-sm font-medium text-ink-soft transition-colors hover:bg-bg disabled:opacity-50"
          onclick={resend}
        ...
        <button
          class="glow pop-self ring-focus w-full rounded-lg px-4 py-2 text-xs font-medium text-ink-faint transition-colors hover:text-ink-soft"
